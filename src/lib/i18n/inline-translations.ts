...
export const INLINE_TRANSLATIONS: Record<string, InlineEntry> = {
  "مخزن الصين": { en: "China warehouse", zh: "中国仓" },
  "أصناف تحت الاستلام": { en: "Awaiting receipt items", zh: "待收货清单" },
  "تم الاستلام": { en: "Received", zh: "已收货" },
  "بانتظار الاستلام": { en: "Awaiting receipt", zh: "待收货" },
  "حفظ التعديل": { en: "Save changes", zh: "保存修改" },
  ...
  "بحث برقم الأمر أو المورد...": { en: "Search by PO or supplier...", zh: "按订单号或供应商搜索..." },
  "لا توجد أوامر شراء.": { en: "No purchase orders.", zh: "暂无采购订单。" },
  "بحث برقم الفاتورة أو ACID": { en: "Search by invoice no. or ACID", zh: "按发票号或 ACID 搜索" },
  "كل الحالات": { en: "All statuses", zh: "全部状态" },
  "اسم المورد": { en: "Supplier name", zh: "供应商名称" },
  "كود تلقائي": { en: "Auto code", zh: "自动编号" },
  "الدولة": { en: "Country", zh: "国家" },
  "الهاتف": { en: "Phone", zh: "电话" },
  "بحث بالاسم أو الكود أو الدولة": { en: "Search by name, code, or country", zh: "按名称/代码/国家搜索" },
  "الكود لا يُعدَّل": { en: "Code cannot be edited", zh: "编号不可修改" },
  "اسم الشركة": { en: "Company name", zh: "公司名称" },
  "اسم إنجليزي": { en: "English name", zh: "英文名称" },
  "اسم الفئة": { en: "Category name", zh: "类别名称" },
  "كود (اختياري)": { en: "Code (optional)", zh: "代码（可选）" },
  "تحت فئة — ابحث (فاضي = رئيسية)": { en: "Under category — search (empty = root)", zh: "上级类别—搜索（留空=主类）" },
  "نشطة": { en: "Active", zh: "启用" },
  "اختر الميناءين وأدخل مدة الشحن بالأيام.": { en: "Select ports and enter duration (days).", zh: "请选择两个港口并输入运输天数。" },
  "مسار": { en: "route", zh: "路线" },
  "المدة (يوم)": { en: "Duration (days)", zh: "时长（天）" },
  "بحث بالمسار أو الميناء": { en: "Search by route or port", zh: "按路线或港口搜索" },
  "تقرير منتج": { en: "Product report", zh: "产品报告" },
  "لم يُعثر على منتج بهذا البحث.": { en: "No product found for this search.", zh: "未找到符合条件的产品。" },
  "ابحث بالاسم أو SKU أو التصنيف أو الباركود": { en: "Search by name, SKU, category, or barcode", zh: "按名称/SKU/类别/条形码搜索" },
  "بحث": { en: "Search", zh: "搜索" },
  "وُجد": { en: "Found", zh: "找到" },
  "منتج": { en: "product(s)", zh: "个产品" },
  "اختر منتجا لعرض التفاصيل": { en: "Select a product to view details", zh: "选择一个产品查看详情" },
  "تشغيل كمورد": { en: "Run as supplier", zh: "以供应商身份运行" },
  "كمورد": { en: "As supplier", zh: "作为供应商" },
  "حذف": { en: "Delete", zh: "删除" },
  "...": { en: "...", zh: "..." },
