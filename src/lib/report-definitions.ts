...
export const REPORTS: Array<{
  ...
  { slug: "summary", title: "ملخص الشحنات", description: "كل الشحنات: ACID، الشركة، الكراتين، القيمة، التواريخ، الحالة، ونوع البضاعة.", dateFilter: "eta", dateHint: "فلترة حسب تاريخ الوصول المتوقع (ETA)" },
